class AddInvestimentos20121021 < ActiveRecord::Migration
  def up
  	...
  	Investimento.create tema: "mobilidade_urbana", valor_previsto: 12363044736.84, valor_contratado: 6823525116.10, valor_executado: 614753718.52
