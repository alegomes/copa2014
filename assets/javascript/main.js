jQuery(function() {
	...
	geraCirculo("estadio_circulo", 204, 204, 89, 102, 24, 4, {
  ...
  //Aeroportos
	...
	geraCirculo("aeroporto_circulo", 204, 204, 89, 102, 24, 4, {
  ...
  geraGrafico("grafico_aeroportos", json_aeroportos);
	...
	geraCirculo("mobilidade_urbana_circulo", 204, 204, 89, 102, 24, 4, {
  ...
  //Desenvolvimento Turistico
	...
	geraCirculo("desenvolvimento_turistico_circulo", 204, 204, 89, 102, 24, 4, {
  ...
  geraGrafico("grafico_desenvolvimento_turistico", json_desenvolvimento_turistico);
	...
	geraCirculo("seguranca_circulo", 204, 204, 89, 102, 24, 4, {
  ...
  //Portos
	...
	geraCirculo("porto_circulo", 204, 204, 89, 102, 24, 4, {
